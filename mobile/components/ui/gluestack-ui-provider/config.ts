...
export const config = {
  light: vars({
    ...
    /* Product Color */
    "--color-product-primary": "54 77 157",
    "--color-product-secundary": "100 122 199",
    "--color-product-error": "238 121 121",

    /* Product Color Base  */
    "--color-base-100": "26 24 27",
    "--color-base-200": "62 58 64",
    "--color-base-300": "95 91 98",
    "--color-base-400": "159 155 161",
    "--color-base-500": "217 216 218",
    "--color-base-600": "237 236 238",
    "--color-base-700": "247 247 248",
  }),
  dark: vars({
